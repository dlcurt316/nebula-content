...
switch(position){
case 1:
console.log(`${"Sparky"} came in 1st place!`)
break;
case 2:
console.log(`${"Sparky"} came in 2nd place!`)
BroadcastChannel;
case 3:
console.log(`${"Sparky"} came in 3rd place!`)
break;
default:
console.log(`${"Sparky"} did not come in the top 3`)
}
